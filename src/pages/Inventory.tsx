...
const filterProducts = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Search Bar */}
      <div className="bg-white dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-dark-100  rounded-xl shadow-sm p-6 border border-gray-100 dark:border-white-100">
                  ...
                  <tr key={product.id} className="hover:bg-gray-200 dark:hover:bg-gray-600">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div>
                        ...
                        <div className="text-sm text-gray-500 dark:hover:text-white">{product.category}</div>
                      </div>
                    </td>
